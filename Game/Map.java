...
public class Map {
	...
	private String filePath; //maby not neccesary
	private static Point3D UpperLeft;	//Upper left edge coordinate
	private static Point3D BottomRight;
	...
	public Map(String path, Point3D coord_upper_left, Point3D coord_bottom_right) {
		...
		try {
			myImage = ImageIO.read(new File(filePath));//"C:\\Users\\InnaPC\\Documents\\OOP_3\\Ex3\\Ariel1.png"
		} catch (IOException e) {
			e.printStackTrace();
		}	
	}
	...
	/**
	 * Calculate the distance in meters between 2 pixels points in the frame
	 * each meter in the real world is 0.676 pixel estimate in the map's picture 
	 * @param px1
	 * @param px2
	 * @return
	 */
	...
	// convert number of pixels to meters in real world
	...
	// convert number of meters to pixels in map - how many pixels in 1 meter
