...
public class GameFrame extends JPanel implements MouseListener, ActionListener, ComponentListener{
	...
	private final String imagePackman = "C:\\Users\\InnaPC\\Documents\\OOP_3\\Ex3\\Packman.png";
	private final String imageFruit = "C:\\Users\\InnaPC\\Documents\\OOP_3\\Ex3\\Fruit.png";
	...
	private void step() {
		...
		for (Packman p : game.getPackmans()) {
			Path path = p.getPath();
			p.setLocation(path.pointAt(TIME/1000));
		}
	...
	public void mouseClicked(MouseEvent arg0) {
		if (status.equals("DRAW_FRUIT")) { 
			...
			y = arg0.getY();
			counter++;
			Fruit newFruit = new Fruit(new Point3D(x,y), counter);
			...
			y = arg0.getY();
			counter++;
			Packman newPackman = new Packman(new Point3D(x,y),counter); 
